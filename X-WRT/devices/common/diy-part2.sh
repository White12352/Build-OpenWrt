...
rm -rf package/feeds/opkgsw/luci-theme-argon/htdocs/luci-static/argon/favicon.ico
rm -rf package/feeds/opkgsw/luci-theme-argon/htdocs/luci-static/argon/img/argon.svg
rm -rf package/feeds/opkgsw/luci-theme-argon/htdocs/luci-static/argon/icon/android-icon-*.png
rm -rf package/feeds/opkgsw/luci-theme-argon/htdocs/luci-static/argon/icon/apple-icon-*.png
rm -rf package/feeds/opkgsw/luci-theme-argon/htdocs/luci-static/argon/icon/favicon-*.png
rm -rf package/feeds/opkgsw/luci-theme-argon/htdocs/luci-static/argon/icon/ms-icon-*.png
cp $GITHUB_WORKSPACE/$OP_MANUFACTURER/devices/common/argon/favicon.ico package/feeds/opkgsw/luci-theme-argon/htdocs/luci-static/argon/
cp $GITHUB_WORKSPACE/$OP_MANUFACTURER/devices/common/argon/argon.svg package/feeds/opkgsw/luci-theme-argon/htdocs/luci-static/argon/img/
cp $GITHUB_WORKSPACE/$OP_MANUFACTURER/devices/common/argon/icon/* package/feeds/opkgsw/luci-theme-argon/htdocs/luci-static/argon/icon/
